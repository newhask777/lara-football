<div class="league_games_item flex flex-row justify-between border-b last:border-none bg-white p-3 hover:bg-gray-100">
    ...
    <!-- Teams -->
    <a href="/predictions/{{ $game->event_id }}" class="flex w-4/6 flex flex-row justify-between">

        <div class="flex home_team w-5/12">
            <div class="rounded-full  p-1 mt-auto mb-auto">

                <img src="{{ asset('/logos/'. $game->home_team .'.png') }}" alt="" class="w-4 mt-auto mb-auto">
        ...
        <div class="away_team w-5/12 flex justify-end">
            ...
            <div class="rounded-full  p-1 mt-auto mb-auto">
                ...
                <img src="http://127.0.0.1:8001/public/logos/{{$game->away_team}}.png" alt="" class="w-4 mt-auto mb-auto">
    ...
    <div class="statistics w-1/6 flex flex-row justify-end">
        <div class="">
            ...
            <span class="inline-block align-middle text-xs">
                    <a href="">
                         @if($game->status == "won")
